  ...
  return (
    <div className={s.wrapper}>
      <div className={s.content}>
        <div className="absolute left-[8%] -top-10 w-20 h-20 rounded-full flex items-center justify-center text-[#fff] uppercase text-2xl bg-[#89c12c]">{advertisementLabel}</div>
