...
export const ClientBanner: React.FC<ClientBannerProps> = ({ data }) => {
  ...
  return (
    <Container>
      <div className='flex'>
        <div className='flex flex-col gap-4 w-[33.3%]'>
            ...
            return (
              <div key={index} className="gap-6 flex items-center mb-4">
                ...
                <div className='flex flex-col'>
                  ...
                  <div className="text-heading max-w-[23rem]">{description}</div>
                </div>
              </div>
            )
          })}
        </div>
        <div className='w-[33.3%] flex gap-4 justify-center align-center'>
