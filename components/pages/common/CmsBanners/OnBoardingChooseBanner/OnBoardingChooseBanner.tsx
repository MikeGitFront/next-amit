    ...
    <Container>
      <div className="my-8 flex flex-col">
        <div className="flex my-12 flex-col justify-center items-center text-text-primary">
          <div className="mb-10 font-bold font-secondary text-[2.8rem]">{title}</div>
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="max-w-[60%] grid grid-cols-3 w-full my-6 mb-10">{items.map(({ image, title }, index) => {
            return (
